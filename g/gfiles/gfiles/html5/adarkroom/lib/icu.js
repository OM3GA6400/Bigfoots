(function() {
	...
	var df = {SHORT_PADDED_CENTURY:function(d){if(d){return((String(d.getDate()+101)).substring(1)+'/'+(String(d.getMonth()+101)).substring(1)+'/'+d.getFullYear());}},SHORT:function(d){if(d){return((String(d.getDate()+101)).substring(1)+'/'+(String(d.getMonth()+101)).substring(1)+'/'+(String(d.getFullYear())).substring(2));}},SHORT_NOYEAR:function(d){if(d){return((String(d.getDate()+101)).substring(1)+'/'+(String(d.getMonth()+101)).substring(1));}},SHORT_NODAY:function(d){if(d){return((String(d.getMonth()+101)).substring(1)+'/'+(String(d.getFullYear())).substring(2));}},MEDIUM:function(d){if(d){return(d.getDate()+' '+dfs.month_short[d.getMonth()]+' '+d.getFullYear());}},MEDIUM_NOYEAR:function(d){if(d){return(d.getDate()+' '+dfs.month_short[d.getMonth()]);}},MEDIUM_WEEKDAY_NOYEAR:function(d){if(d){return(dfs.day_short[d.getDay()]+' '+d.getDate()+' '+dfs.month_short[d.getMonth()]);}},LONG_NODAY:function(d){if(d){return(dfs.month_name[d.getMonth()]+' '+d.getFullYear());}},LONG:function(d){if(d){return(d.getDate()+' '+dfs.month_name[d.getMonth()]+' '+d.getFullYear());}},FULL:function(d){if(d){return(dfs.day_name[d.getDay()]+' '+d.getDate()+' '+dfs.month_name[d.getMonth()]+' '+d.getFullYear());}}};
